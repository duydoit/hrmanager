...
class Employee(models.Model):
    ...
    owner = models.OneToOneField(User, related_name="owner", on_delete=models.CASCADE,null=True, blank=True)
    ...
    parent = models.ForeignKey('self', null=True, blank=True, on_delete=models.CASCADE, related_name="manager")
    department = models.ForeignKey(Department,null=True,on_delete = models.CASCADE,related_name="department")
